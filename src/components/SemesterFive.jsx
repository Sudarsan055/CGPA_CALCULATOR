...
export default function SemesterFive(props) {
    ...
    const [sgpaFive,setsgpaFive]=useState(0)
    const[gradepointFive,setGradepointFive]=useState(0)
    const{Datafive,Datacheckfive}=useContext(UserContext)
    const calculatesgpa=()=>{
        setsgpaFive(()=>{
            if(grade.maths<11&&grade.maths>1 && grade.basicelectronic<11&&grade.basicelectronic>1 && grade.pfps<11&&grade.pfps>1 && grade.civil<11&&grade.civil>1 && grade.chemistry<11&&grade.chemistry>1 && grade.lab1<11&&grade.lab1>1 &&grade.lab2<11&&grade.lab2>1 && grade.lab3<11&&grade.lab3>1 && grade.lab4<11&&grade.lab4>1){
                return (grade.maths*3+grade.basicelectronic*3+grade.pfps*3+grade.civil*3+grade.chemistry*3+grade.lab1*2+grade.lab2*1.5+grade.lab3*1.5+grade.lab4*1.5)/21.5
            }else{
        ...
        setGradepointFive(()=>{
            if(grade.maths<11&&grade.maths>1 && grade.basicelectronic<11&&grade.basicelectronic>1 && grade.pfps<11&&grade.pfps>1 && grade.civil<11&&grade.civil>1 && grade.chemistry<11&&grade.chemistry>1 && grade.lab1<11&&grade.lab1>1 &&grade.lab2<11&&grade.lab2>1 && grade.lab3<11&&grade.lab3>1 && grade.lab4<11&&grade.lab4>1){
                return (grade.maths*3+grade.basicelectronic*3+grade.pfps*3+grade.civil*3+grade.chemistry*3+grade.lab1*2+grade.lab2*1.5+grade.lab3*1.5+grade.lab4*1.5)
            }else{
                return("Enter the correct value")
            }
        })
        ...
        Datafive(gradepointFive)
        Datacheckfive(toggle)
    }
    
  return (
    <div className="Cgpacalculator">
      <h1 style={{ margin: "0" }}>Semester-V</h1>
