...
export default function SemesterSix(props) {
    ...
    const [sgpaSix,setsgpaSix]=useState(0)
    const[gradepointSix,setGradepointSix]=useState(0)
    const{Datasix,Datachecksix}=useContext(UserContext)
    const calculatesgpa=()=>{
        setsgpaSix(()=>{
        ...
        Datasix(gradepointSix)
        Datachecksix(toggle)
    }
    
  return (
    <div className="Cgpacalculator">
      <h1 style={{ margin: "0" }}>Semester-VI</h1>
