...
export default function SemesterTwo(props) {
    ...
    const [sgpaTwo,setsgpaTwo]=useState(0)
    const[gradepointTwo,setGradepointTwo]=useState(0)
    const{Datatwo,Datachecktwo}=useContext(UserContext)
    const calculatesgpa=()=>{
        setsgpaTwo(()=>{
        ...
        Datatwo(gradepointTwo)
        Datachecktwo(toggle)
    }
    
  return (
    <div className="Cgpacalculator">
      <h1 style={{ margin: "0" }}>Semester-II</h1>
